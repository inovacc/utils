...
// HashPassword generates a secure, encoded Argon2ID hash string using Base58.
...
// CheckPasswordHash verifies if a given plain password matches the Base58-encoded hash.
